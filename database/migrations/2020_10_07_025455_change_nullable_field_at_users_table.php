...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->integer('fk_categories_id')->nullable()->change();
    ...
    public function down()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->integer('kf_provinces_id')->nullable(false)->change();
            $table->integer('kf_regencies_id')->nullable(false)->change();
            $table->integer('zip_code')->nullable(false)->change();
            $table->string('country')->nullable(false)->change();
            $table->string('phone_number')->nullable(false)->change();
            $table->string('store_name')->nullable(false)->change();
            $table->integer('fk_categories_id')->nullable(false)->change();
